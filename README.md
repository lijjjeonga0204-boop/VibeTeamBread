...
| 데이터 구분 | 활용 기능 | 데이터 출처 | 라이선스 |
|---|---|---|---|
| 관광지 정보 | 지역정보 목록, 지도, 상세정보, 챗봇 | 프로젝트 제공 데이터 | 기능 명세서 기준 입력 |
| 문화시설 정보 | 지역정보 목록, 지도, 상세정보 | 프로젝트 제공 데이터 | 기능 명세서 기준 입력 |
| 축제공연행사 정보 | 축제 캘린더, 상세정보, 챗봇 | 프로젝트 제공 데이터 | 기능 명세서 기준 입력 |
| 여행 관련 정보 | 지역정보 조회 및 추천 | 프로젝트 제공 데이터 | 기능 명세서 기준 입력 |

> 최종 제출 전 기능 명세서에 작성한 실제 데이터 출처, 공공누리 유형, 라이선스 및 수집일을 동일하게 반영해야 합니다.
